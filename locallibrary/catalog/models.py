...
class Genre(models.Model):
    ...
    """
    name = models.CharField(max_length=200, help_text="Enter the book genre (e.g. Science Fiction, French Poetry, etc.)")
...
class Language(models.Model):
    """
    Model for representing the book's natural language (e.g. English, French, etc)
    """
    name = models.CharField(max_length=200, help_text="Enter the book's natural language (e.g. English, French, Japanase, etc.")

    def __str__(self):
        """
        String for representing the Moel object
        """
        return self.name
class Book(models.Model):
    """
    Model representing the book (but not specific copy of book).
    """
    ...
    def get_absolute_url(self):
        return reverse('book-detal', args=[str(self.id)])
...
class BookInstance(models.Model):
    ...
    def __str__(self):
        ...
        # return f'{self.id} ({self.book.title}) # Use this if works
...
class Author(models.Model):
    ...
    death_of_birth = models.DateField(null=True, blank=True)
